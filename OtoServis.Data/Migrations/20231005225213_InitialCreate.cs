        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceOutDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ...
                    ChassisNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedDate", "Email", "IsActive", "Name", "Password", "Phone", "RolesId", "Surname", "Username" },
                values: new object[] { 1, new DateTime(2023, 10, 6, 1, 52, 13, 670, DateTimeKind.Local).AddTicks(7668), "admin@gmail.com", true, "admin", "12345", "0530", 1, "admin", "admin" });
